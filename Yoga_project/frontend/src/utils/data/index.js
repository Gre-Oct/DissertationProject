...
export const tutorials = [
    '1. The application will ask for permission to use the camera of the device. Allow access to capture video content and correct pose.',
...
export const fixCamera = [
    'Solution 1. Make sure to allow camera permission for the browser. If permission is denied, go to the browser’s settings and allow camera access to the application.',
    'Solution 2. Make sure that other applications are not using the camera.',
